...
public class ApiContants {
    ...
    //tid前端
    public static final int TID_FRONT=5;
    //tid资讯
    public static final int TID_NEWS=4;
    //程序设计
    public static final int TID_PROGRAM_DESIGN=6;
    //Ios开发
    public static final int TID_IOS=27;
    //数据库
    public static final int TID_DB=14;
    //每日一站
    public static final int TID_DAILY=9;
    //应用推荐
